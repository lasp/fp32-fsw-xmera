...
TEST(NavAggregateTest, ReferenceTest) {
    testNavAggregate(7489.3,
                     std::vector<float>{234.5, -243.23, 134.13},
                     std::vector<float>{-867.89, 342.34, -876.67},
                     std::vector<float>{4.89, 6.12, 423.48},
                     100.1,
                     std::vector<double>{10060.5, -239847.23, 82148.13},
                     std::vector<double>{-3786.89, 234798.34, -7389.67},
                     std::vector<float>{2345.89, 3432.12, 2342.48},
                     1,
                     2,
                     3,
                     4,
