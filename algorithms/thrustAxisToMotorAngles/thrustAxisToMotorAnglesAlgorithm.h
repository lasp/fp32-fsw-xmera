...
class ThrustAxisToMotorAnglesAlgorithm final {
   public:
    ...
    void reInitialize();
    ThrustAxisToMotorAnglesOutput update(float gimbalAngle1, float gimbalAngle2);
   ...
   private:
    ...
    ThrustAxisToMotorAnglesOutput previousValidOutput{};  //!< [rad] Last valid algorithm output
