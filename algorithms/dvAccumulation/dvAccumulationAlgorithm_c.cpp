...
Vector3f_c DvAccumulationAlgorithm_update(DvAccumulationAlgorithmHandle* self,
    ...
    const Eigen::Vector3f bias_B = cArrayToEigenVector3(accelBias_B.data);
    const Eigen::Vector3f vehAccumDV_B = fsw::fromHandle<::DvAccumulationAlgorithm>(self)->update(accel_B, bias_B);
