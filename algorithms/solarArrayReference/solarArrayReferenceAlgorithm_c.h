 ...
 */
void SolarArrayReferenceAlgorithm_setAlignmentThreshold(SolarArrayReferenceAlgorithm* self, float threshold);
 ...
 */
void SolarArrayReferenceAlgorithm_setTrackingMode(SolarArrayReferenceAlgorithm* self, TrackingMode mode);
 ...
 */
void SolarArrayReferenceAlgorithm_setSpecifiedArrayAngle(SolarArrayReferenceAlgorithm* self, float angle);
 ...
 */
void SolarArrayReferenceAlgorithm_setOffsetAngle(SolarArrayReferenceAlgorithm* self, float angle);
