...
def test_att_tracking_error():
    ...
    nav_state_out_data = messaging.NavAttMsgPayload()
    ...
    nav_state_in_msg = messaging.NavAttMsg().write(nav_state_out_data)

    # Create reference frame message
    ref_state_out_data = messaging.AttRefMsgPayload()
    ...
    ref_in_msg = messaging.AttRefMsg().write(ref_state_out_data)
