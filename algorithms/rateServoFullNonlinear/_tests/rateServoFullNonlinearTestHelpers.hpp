#ifndef TEST_RATESERVOFULLNONLINEAR_H
#define TEST_RATESERVOFULLNONLINEAR_H
...
ReferenceOutput referenceUpdate(const RateServoFullNonlinearAlgorithm& alg,
...
inline void testRateServoFullNonlinearSetup() {
    RateServoFullNonlinearAlgorithm alg{};

    // --- Test expected exceptions ---

    // Negative feedback gain or integral limit
...
inline void testRateServoFullNonlinear(float P,
                                       float Ki,
                                       float integralLimit,
                                       ...
                                       std::vector<float> omega_BastR_B,
                                       std::vector<float> omegap_BastR_B,
    ...
    RateCmdMsgF32Payload rateCmdMsg{};
    std::copy(omega_BastR_B.begin(), omega_BastR_B.end(), rateCmdMsg.omega_BastR_B);
    std::copy(omegap_BastR_B.begin(), omegap_BastR_B.end(), rateCmdMsg.omegap_BastR_B);
...
#endif  // TEST_RATESERVOFULLNONLINEAR_H
