...
void TwoAxisGimbalAxisToMotorAngles::updateState(uint64_t currentSimNanos) {
    ...
    if (this->thrustDirectionInMsg.isWritten() &&
        ...
        MotorAngles motorAngles = gimbalAnglesToMotorAngles(this->gimbalTipAngle, this->gimbalTiltAngle);
...
*/
MotorAngles TwoAxisGimbalAxisToMotorAngles::gimbalAnglesToMotorAngles(double gimbalTipAngle, double gimbalTiltAngle) {
...
*/
MotorAngles TwoAxisGimbalAxisToMotorAngles::pullAngles(double gimbalAngle1, double gimbalAngle2) const {
...
/*! This method determines if bilinear interpolation is required to obtain the desired angles.
 ...
 @param gimbalAngle2 [rad]
*/
bool TwoAxisGimbalAxisToMotorAngles::bilinearInterpolationRequired(double gimbalAngle1, double gimbalAngle2) {
...
/*! This method determines if no interpolation is required to obtain the desired angles.
 ...
 @param gimbalAngle2 [rad]
*/
bool TwoAxisGimbalAxisToMotorAngles::noInterpolationRequired(double gimbalAngle1, double gimbalAngle2) {
    double motor1Rounded = round(fabs(gimbalAngle1 / this->tableStepAngle));
    double motor1Exact = fabs(gimbalAngle1 / this->tableStepAngle);
    double motor1Remainder = fabs(motor1Exact - motor1Rounded);
...
/*! This method determines if linear interpolation is required to obtain the desired angles.
 ...
 @param angle [rad]
*/
bool TwoAxisGimbalAxisToMotorAngles::linearInterpolationRequired(double angle) {
...
computeTableEdgeCase() is called to determine the appropriate motor angles.
 @return void
*/
MotorAngles TwoAxisGimbalAxisToMotorAngles::bilinearlyInterpolateAngles(double gimbalAngle1, double gimbalAngle2) {
...
*/
MotorAngles TwoAxisGimbalAxisToMotorAngles::linearlyInterpolateAngles(double gimbalAngle1,
                                                                      double gimbalAngle2,
