#ifndef F32XMERA_TWO_AXIS_GIMBAL_AXIS_TO_MOTOR_ANGLES_TYPES_H
#define F32XMERA_TWO_AXIS_GIMBAL_AXIS_TO_MOTOR_ANGLES_TYPES_H
...
/*! @brief Output of the two-axis gimbal axis-to-motor angles algorithm (C-shared POD). */
typedef struct TwoAxisGimbalAxisToMotorAnglesOutput {
...
} TwoAxisGimbalAxisToMotorAnglesOutput;

#ifdef __cplusplus
}  // extern "C"
#endif

#endif  // F32XMERA_TWO_AXIS_GIMBAL_AXIS_TO_MOTOR_ANGLES_TYPES_H
