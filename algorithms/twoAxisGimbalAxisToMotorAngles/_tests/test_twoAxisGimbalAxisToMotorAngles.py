...
from xmera.fp32 import twoAxisGimbalAxisToMotorAnglesF32
...
def to_swig_table(np_table):
    ...
    table = twoAxisGimbalAxisToMotorAnglesF32.GimbalMotorTable2D()
...
def test_two_axis_gimbal_axis_to_motor_angles(gimbal_tip_angle_ref, gimbal_tilt_angle_ref):
    r"""
    **Validation Test Description**
    ...
    gimbal_controller = twoAxisGimbalAxisToMotorAnglesF32.TwoAxisGimbalAxisToMotorAngles()
...
if __name__ == "__main__":
    test_two_axis_gimbal_axis_to_motor_angles(14.6 * macros.D2R, -4.8 * macros.D2R)
