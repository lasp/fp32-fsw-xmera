...
/// All math is single-precision (FP32). Degenerate burn-frame geometry and non-finite
/// burn-command inputs return the default output.
class DvGuidanceAlgorithm final {
   public:
    ...
    ///         cannot be constructed or the rotation rate is non-finite.
